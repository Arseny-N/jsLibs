var BarChart = function (data,options) {
		...
		this.drawBar = function(bar, n) {
			...
			if(this.click)		
			        bar.chart.masterHit.click(this.click.bar);
					        	
			bar.chart.red.mouseenter(f_enter);	
			bar.chart.red.mouseleave(f_leave);
			if(this.click)	
			        bar.chart.red.click(this.click.bar);	
							        
			bar.chart.green.mouseenter(f_enter);	
			bar.chart.green.mouseleave(f_leave);	
			if(this.click)	
			        bar.chart.green.click(this.click.bar);					
				 							       
			bar.chart.masterHit.remember({'bar':bar});
			bar.chart.red.remember({'bar':bar});
			bar.chart.green.remember({'bar':bar});
