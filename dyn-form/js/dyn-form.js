var FORM = {
	...
	questions : [
			...
			answers : [
				{	
					...
					input : {							
						...
						passwd : true,
						set : 'weight',
						text : 	'Введите пожалуйста ваш вес (кг)',
						range : [0, 200],
			...
			answers : [
				{	
					...
					input : {							
						...
						set : 'height',
						text : 	'Введите пожалуйста ваш рост (см)',
						range : [0, 300],
		...
		{ 
			text : 	'У вас есть возможность измерить температуру вашего тела ?',
			answers : [
				{	
					classes : 'success',
					text : 'да',
...
var DynForm = function(form) {
	...
	this.runFuncsLookup = {
		...
		'timer' : function(cb) {
			...
			var stop = self.button('стоп').hide();
